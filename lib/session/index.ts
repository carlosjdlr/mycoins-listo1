...
export type SessionTokenSet = {
	...
	nonce?: string | null;
	/**
	 * Qué cliente OAuth emitió estos tokens (`mycoins-api` o `mycoins-mobile`). Sin esto,
	 ...
	 * Opcional por compatibilidad con sesiones creadas antes de esta feature: ausente =
	 * cliente web confidencial, el comportamiento de siempre.
	 */
	clientId?: string;
};
