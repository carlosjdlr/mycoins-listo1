...
const envSchema = z.object({
	...
	// Cliente publico para la app movil (mycoins-ionic, Capacitor): sin secreto, login con
	...
	SESSION_COOKIE_NAME: z.string().min(1).default('mycoins_session'),
	SESSION_TEMP_COOKIE_NAME: z.string().min(1).default('mycoins_oauth_state'),
