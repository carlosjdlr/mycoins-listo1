...
2. Autentícate en Keycloak (p. ej. \`estudiante\` / \`mycoins123\`). **La contraseña se escribe en el IdP, nunca en MyCoins.**
...
\`\`\`json
{ "data": { "email": "estudiante@mycoins.local", "roles": [], "permissions": [] } }
\`\`\`
