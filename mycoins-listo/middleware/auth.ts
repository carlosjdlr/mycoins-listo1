...
export const auth = async (
	...
	// mismo payload sellado vía `Authorization: Bearer <token>` — ver feature de
	// autenticación móvil nativa. Se prueba primero porque si viene, es la fuente de
	// verdad explícita del cliente.
