...
Credenciales de práctica: usuario `estudiante`, contraseña `mycoins123`.
...
Con **DevTools → Network** abierto y la casilla *Preserve log* activada. Autenticarse como `estudiante` / `mycoins123`.
